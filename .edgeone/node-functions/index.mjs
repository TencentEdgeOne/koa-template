...
// node_modules/koa/lib/search-params.js
var require_search_params = __commonJS({
  "node_modules/koa/lib/search-params.js"(exports2, module2) {
...
// node_modules/koa/lib/only.js
var require_only = __commonJS({
  "node_modules/koa/lib/only.js"(exports2, module2) {
    module2.exports = (obj, keys) => {
      const ret = {};
...
// node_modules/koa/lib/is-stream.js
var require_is_stream = __commonJS({
  "node_modules/koa/lib/is-stream.js"(exports2, module2) {
    "use strict";
    var Stream = __require("stream");
...
var require_response = __commonJS({
  "node_modules/koa/lib/response.js"(exports2, module2) {
    ...
    var getType = require_mime_types2().contentType;
...
// node_modules/http-assert/node_modules/depd/lib/compat/callsite-tostring.js
var require_callsite_tostring = __commonJS({
  "node_modules/http-assert/node_modules/depd/lib/compat/callsite-tostring.js"(exports2, module2) {
    "use strict";
...
// node_modules/http-assert/node_modules/depd/lib/compat/event-listener-count.js
var require_event_listener_count = __commonJS({
  "node_modules/http-assert/node_modules/depd/lib/compat/event-listener-count.js"(exports2, module2) {
    "use strict";
...
// node_modules/http-assert/node_modules/depd/lib/compat/index.js
var require_compat = __commonJS({
  "node_modules/http-assert/node_modules/depd/lib/compat/index.js"(exports2, module2) {
    "use strict";
    var EventEmitter = __require("events").EventEmitter;
...
// node_modules/http-assert/node_modules/depd/index.js
var require_depd2 = __commonJS({
  "node_modules/http-assert/node_modules/depd/index.js"(exports, module) {
...
// node_modules/http-assert/node_modules/statuses/codes.json
var require_codes3 = __commonJS({
  "node_modules/http-assert/node_modules/statuses/codes.json"(exports2, module2) {
    module2.exports = {
      "100": "Continue",
      "101": "Switching Protocols",
      "102": "Processing",
...
// node_modules/http-assert/node_modules/statuses/index.js
...
var require_http_errors2 = __commonJS({
  "node_modules/http-assert/node_modules/http-errors/index.js"(exports2, module2) {
    "use strict";
...
var require_application = __commonJS({
  "node_modules/koa/lib/application.js"(exports2, module2) {
    "use strict";
    var util = __require("util");
    var debug = util.debuglog("koa:application");
    ...
    module2.exports = class Application extends Emitter {
      ...
      listen(...args2) {
        debug("listen");
        const server2 = http2.createServer(this.callback());
        return server2.listen(...args2);
      }
      /**
       * Return JSON representation.
      ...
      handleRequest(ctx, fnMiddleware) {
        ...
        const handleResponse2 = () => respond(ctx);
        onFinished(res, onerror);
        return fnMiddleware(ctx).then(handleResponse2).catch(onerror);
      }
      /**
...
`);
    ...
    function respond(ctx) {
      ...
      if (body instanceof Response) {
        return Stream.Readable.from((body == null ? void 0 : body.body) || "").pipe(res);
      }
      if (isStream(body))
...
var server = http.createServer(async (req, res) => {
  try {
    ...
    {
      const routePattern = new RegExp("^/koa/.*$");
      if (routePattern.test(pathname)) {
        const app = mod_1;
        if (app) {
          const pathParts = pathname.split("/").filter(Boolean);
          const routeParts = "/koa/:default*".split("/").filter(Boolean);
          const params = {};
          let frameworkPath = "/";
    ...
    }
    {
      ...
      if (routePattern.test(pathname)) {
        ...
        if (app) {
          const pathParts = pathname.split("/").filter(Boolean);
          const routeParts = "/koa".split("/").filter(Boolean);
          const params = {};
          let frameworkPath = "/";
          let consumedSegments = 0;
          for (let i = 0; i < routeParts.length; i++) {
